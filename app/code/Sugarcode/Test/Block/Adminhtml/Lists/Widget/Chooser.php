 ...
 */
namespace Sugarcode\Test\Block\Adminhtml\Test\Widget;
...
class Chooser extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \Sugarcode\Test\Model\TestFactory $blockFactory,
        \Sugarcode\Test\Model\Resource\Test\CollectionFactory $collectionFactory,
        array $data = []
    ) {
    ...
    public function prepareElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $sourceUrl = $this->getUrl('test/lists_widget/chooser', ['uniq_id' => $uniqId]);
    ...
    {
        return $this->getUrl('test/lists_widget/chooser', ['_current' => true]);
    }
}
